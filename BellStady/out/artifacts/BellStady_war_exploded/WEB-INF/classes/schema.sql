...
CREATE TABLE IF NOT EXISTS Organization(
    ...
    CONSTRAINT FK_Organization_Recvisit FOREIGN KEY(recvisit_id) REFERENCES Recvisit(id),
...
CREATE TABLE IF NOT EXISTS Employee(
    ...
    CONSTRAINT FK_User_Document FOREIGN KEY(document_id) REFERENCES Document(id),
